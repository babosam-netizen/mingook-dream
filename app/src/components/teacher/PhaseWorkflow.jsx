...
export const PHASE_STEPS = {
  ...
  4: [
    { id: 'reflect', session: '19차시',    label: '학생 정리글 작성 안내',                       hint: '5박스 + 마치며',                                       highlight: 'editor',     studentLabel: '정리글 작성' },
    { id: 'approve', session: '19~20차시', label: '정리글 승인 큐 처리',                          hint: '기사 단축키 ⌘+Enter',                                 highlight: 'wall',       studentLabel: '친구들 글 둘러보기' },
    { id: 'gallery', session: '20차시',    label: '갤러리 워크 — 친구들 글에 공감',                hint: '댓글·이모지',                                              highlight: 'wall',       studentLabel: '갤러리 워크' },
    { id: 'closing', session: '20차시',    label: '디브리핑·역할 배지 반납',                     hint: '오프라인에서 진행',                                      highlight: null,         studentLabel: '디브리핑' },
  ],
}
