...
export const DEFAULT_ROLES = {
  ...
  executive_president: [
    {
      key: 'pledge_purpose', label: '공약 목적·대상 담당', emoji: '🦅',
      isRepresentative: true,
      assignedSection: 'skeleton',
      sectionLabel: '공약 시행령 제1조 — 목적·대상 (연계 법령 명시)',
      sectionPlaceholder: '이번 통과 법령과 연결할 우리 공약을 정하고, 그 공약 시행령의 이름·목적(제1조)과 적용 대상(제2조)을 써 주세요.',
      memoGuide: [
        '① 우리가 이번 법령과 함께 실현할 공약은 무엇인가요? 그 공약의 이름과, 이 법령과 어떻게 연결되는지 한 줄로 정리해 주세요.',
        '② 이 공약을 시행령으로 만들면 어떤 문제를 해결하나요? 필요성을 보여 주는 통계나 기사 링크를 붙여 주세요.',
        '③ 이 공약의 혜택을 받을 사람과, 규칙을 지켜야 할 대상은 각각 누구인가요?',
      ],
      todos: [
        { label: '연계 공약 확정 + 제1조(목적)·제2조(대상) 초안 쓰기',
          hint: '등록된 우리 공약 중 이번 법령과 가장 잘 맞는 1개를 골라, 시행령의 이름과 목적·대상을 정하세요.' },
        { label: '공약이 왜 필요한지 근거 찾기',
          hint: '관련 통계·기사·사례를 찾아 링크로 붙여 두세요.' },
        { label: '관련 예산 항목 1개 입력',
          hint: '예: 공약 대상 실태조사비, 안내·홍보비 등' },
        { label: '대표로서 모둠원 초안을 모아 공약 시행령으로 정리',
          hint: '대표 역할을 겸해요. 시행절차·지원내용·점검 담당의 초안을 합쳐 최종 공약 시행령으로 완성하세요.' },
      ],
      budgetSuggestions: [
        { title: '공약 실태조사비', note: '공약 대상 수 × 1인당 조사 비용' },
        { title: '공약 안내·접수비', note: '대상 확인과 신청 접수 운영비' },
      ],
      sosWhen: "'어떤 공약을 법령과 엮을지 고르기 어려울 때'",
      sosLabel: '정책 자문관',
    },
    {
      key: 'pledge_procedure', label: '공약 시행절차 담당', emoji: '📋',
      assignedSection: 'decree',
      sectionLabel: '공약 시행령 제3조 — 시행 절차',
      sectionPlaceholder: '이 공약을 실제로 어떻게 진행할지 써 주세요(제3조). 어느 기관이 담당하고, 신청은 어떻게 하며, 어떤 순서로 지원이 이뤄지나요?',
      memoGuide: [
        '① 이 공약을 누가(어느 기관·부처가) 맡아 시행하나요?',
        '② 신청 → 선정 → 지원이 어떤 순서로 이루어지나요? 단계별로 써 보세요.',
      ],
      todos: [
        { label: '제3조(시행 절차) 초안 쓰기',
          hint: '누가, 언제, 어떤 순서로 진행하는지 단계별로 써 보세요.' },
        { label: '시행에 필요한 사람·장소·시스템 조사',
          hint: '공약을 실제로 굴리려면 무엇이 필요한지 정리하세요.' },
        { label: '관련 예산 항목 1개 입력',
          hint: '예: 담당 인력비, 운영 시스템 구축비 등' },
      ],
      budgetSuggestions: [
        { title: '시행 인력비', note: '담당 인력 수 × 인건비 × 기간' },
        { title: '운영 시스템비', note: '신청·선정·지원 관리 시스템 운영비' },
      ],
      sosWhen: "'시행 절차를 어떻게 짜야 할지 막힐 때'",
      sosLabel: '행정 절차 자문관',
    },
    {
      key: 'pledge_support', label: '공약 지원내용·예산 담당', emoji: '🎁',
      assignedSection: 'evidence',
      sectionLabel: '공약 시행령 제4조 — 지원 내용·재원',
      sectionPlaceholder: '이 공약으로 무엇을 지원하는지 구체적으로 써 주세요(제4조). 돈·물건·시설 중 무엇인지, 비용 근거와 함께 정리하세요.',
      memoGuide: [
        '① 이 공약으로 사람들이 받게 될 지원은 정확히 무엇인가요? (돈·물건·시설·프로그램 중 무엇인가요?)',
        '② 지원 대상이 몇 명(몇 곳)이고, 1인당(1곳당) 비용은 얼마인가요?',
        '③ 지원이 너무 많거나 적으면 어떤 문제가 생길 수 있나요?',
      ],
      todos: [
        { label: '제4조(지원 내용) 초안 쓰기',
          hint: '무엇을, 누구에게, 어떻게 지원할지 구체적으로 쓰세요.' },
        { label: '지원 규모와 비용 근거 찾기',
          hint: '지원 금액·물품·시설 비용이 왜 이만큼 필요한지 근거를 붙이세요.' },
        { label: '관련 예산 항목 1개 입력',
          hint: '예: 직접 지원금, 장비 구입비 등 — 이 금액이 대통령실 예약 예산이 됩니다.' },
      ],
      budgetSuggestions: [
        { title: '공약 지원금', note: '지원 대상 수 × 1인(1곳)당 지원액' },
        { title: '지원 물품·시설비', note: '수량 × 단위 비용' },
      ],
      sosWhen: "'지원 규모·재원 근거를 찾기 어려울 때'",
      sosLabel: '재정 자문관',
    },
    {
      key: 'pledge_review', label: '공약 점검·효과 담당', emoji: '📊',
      assignedSection: 'effect',
      sectionLabel: '공약 시행령 제5조 — 점검·기대효과·부처 협조',
      sectionPlaceholder: '이 공약이 잘 되는지 어떻게 확인하고, 기대효과는 무엇이며, 각 부처가 어떻게 협조해야 하는지 써 주세요(제5조).',
      memoGuide: [
        '① 이 공약이 잘 돌아가는지 어떻게 확인하나요? (점검 기준·주기)',
        '② 공약이 시행되면 좋아지는 점(기대효과)은 무엇인가요? 손해 볼 수 있는 사람과 보완책도 함께 적어 주세요.',
        '③ 이 공약을 위해 각 부처(장관)들이 협조해야 할 일은 무엇인가요? (국무회의 업무지시의 바탕이 됩니다.)',
      ],
      todos: [
        { label: '제5조(점검·기대효과) 초안 쓰기',
          hint: '점검 기준과 기대효과, 손해 볼 수 있는 사람의 보완책을 쓰세요.' },
        { label: '부처 협조·업무지시 후보 정리',
          hint: '국무회의에서 각 부처에 내릴 업무지시의 바탕이 됩니다. 어느 부처가 무엇을 도와야 하는지 적어 두세요.' },
        { label: '관련 예산 항목 1개 입력',
          hint: '예: 성과 점검비, 민원 대응비 등' },
      ],
      budgetSuggestions: [
        { title: '공약 점검·평가비', note: '점검 인력·성과 평가 운영비' },
        { title: '보완·민원 대응비', note: '보완 대상 수 × 단가' },
      ],
      sosWhen: "'기대효과 예측이나 부처 협조 정리가 어려울 때'",
      sosLabel: '정책 분석관',
    },
  ],
  judicial: [
