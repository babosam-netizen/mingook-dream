...
export const DEFAULT_ROLES = {
  ...
  executive_president: [
    {
      key: 'president', label: '대통령', emoji: '🦅',
      isRepresentative: true,
      assignedSection: 'cabinet_moderator',
      sectionLabel: '대통령실 — 국무회의 준비 및 최종 공약 이행 지시',
      sectionPlaceholder: '대통령으로서 우리 정부의 국정 방향과 최우선 순위 공약을 명확히 하고, 이를 이행하기 위한 부처별 지시사항과 국무회의 준비 내용을 정리하세요.',
      memoGuide: [
        '① [국정 방향 및 공약 이행] 우리 정부가 이번 여정에서 반드시 지키고자 하는 핵심 공약은 무엇인가요? (예: 친환경 국가 건설, 취약계층 지원 확대 등)',
        '② [국무회의 안건 조율] 각 부처(장관)들이 낸 정책 중 우리 정부의 핵심 공약 방향과 충돌하거나 추가적인 조정이 필요한 부분은 무엇인가요?',
        '③ [부처 지시사항] 공약을 보다 실효성 있게 이행하기 위해 각 부처 장관들에게 내릴 구체적인 지시사항은 무엇인가요?'
      ],
      todos: [
        { label: '핵심 국정 방향 및 1순위 공약 설정', hint: '우리 정부가 집중할 핵심 과제와 공약 목표를 명확히 정하고 메모해 두세요.' },
        { label: '국무회의 안건 및 부처별 쟁점 질문지 준비', hint: '비서관들의 보고서를 바탕으로 각 부처 장관들에게 국무회의 때 질문할 사항을 정리하세요.' },
        { label: '공약 이행을 위한 부처별 최종 지시사항 작성', hint: '국무회의 토론 후 최종 정책/예산안에 반영할 부처별 지시사항을 확정하세요.' }
      ],
      sosWhen: '\'예산 갈등 조율이나 부처 지시사항 작성이 어려울 때\'',
      sosLabel: '정치학 전문교수',
    },
    {
      key: 'chief_of_staff', label: '비서실장', emoji: '💼',
      assignedSection: 'president_support',
      sectionLabel: '비서실 — 국무회의 의제 및 공약 이행 현황 종합',
      sectionPlaceholder: '비서실장으로서 각 부처의 정책 초안을 종합하고, 대통령의 공약과 비교하여 주요 쟁점과 국무회의 의제를 작성하세요.',
      memoGuide: [
        '① [부처 정책 종합] 각 부처가 청구한 정책 및 예산안 중에서 가장 핵심적인 사업과 우선순위는 무엇인가요?',
        '② [공약 정합성 검토] 각 부처의 정책이 대통령의 공약 방향과 일치하는지 검토한 결과를 적어 주세요.',
        '③ [국무회의 시나리오 기획] 대통령의 모두발언 내용과 각 부처 간 이견을 조정할 회의 진행 시나리오를 구상해 보세요.'
      ],
      todos: [
        { label: '부처별 정책 요약 및 공약 검토서 작성', hint: '각 부처가 등록한 초안을 읽고 대통령의 핵심 공약에 부합하는지 쟁점을 정리하세요.' },
        { label: '대통령 국무회의 모두발언 및 시나리오 기획', hint: '대통령이 국무회의를 주재할 때 사용할 발언 가이드라인과 쟁점 순서를 작성하세요.' },
        { label: '부처 간 이견 조율을 위한 중재안 마련', hint: '예산 총액 100억 한도 내에서 갈등이 생길 경우를 대비한 1차 중재안을 기획하세요.' }
      ],
      sosWhen: '\'부처 간 정책 쟁점 조율이 복잡할 때\'',
      sosLabel: '행정학 전문가',
    },
    {
      key: 'secretary_civil', label: '민정비서관', emoji: '💬',
      assignedSection: 'discussion_summary',
      sectionLabel: '민정비서실 — 여론 분석 및 소통·홍보 전략',
      sectionPlaceholder: '민정비서관으로서 정부 정책에 대한 시민들의 여론과 우려사항을 분석하고, 국민들의 공감대를 얻기 위한 소통·홍보 지침을 작성하세요.',
      memoGuide: [
        '① [국민 여론 분석] 온라인 시민 정책토의나 댓글에서 우리 정부 정책에 대해 국민들이 가장 우려하거나 반대하는 지점은 무엇인가요?',
        '② [민심 반영 보완책] 국민들의 우려를 해소하고 설득하기 위해 정책에 추가로 반영해야 할 보완책이나 혜택은 무엇인가요?',
        '③ [대국민 홍보 전략] 정부의 공약 이행 의지를 알리고 국민들의 참여를 유도할 슬로건과 소통 방법을 제안하세요.'
      ],
      todos: [
        { label: '시민 정책토의 여론 및 우려사항 분석', hint: '시민 게시판의 댓글을 긍정/부정/제안 의견으로 분류하여 주요 걱정거리를 요약하세요.' },
        { label: '여론 수렴을 통한 민심 반영 정책 보완 제안', hint: '국민들의 거부감을 줄이고 설득력을 높일 수 있는 구체적인 보완 방안을 제안서에 담아보세요.' },
        { label: '정부 공약 핵심 슬로건 및 국민 홍보안 기획', hint: '국민들이 쉽게 이해하고 공감할 수 있는 정책 홍보 슬로건과 홍보 채널을 설계해 작성하세요.' }
      ],
      sosWhen: '\'시민 여론 분석 및 홍보 아이디어가 막힐 때\'',
      sosLabel: '소통학 전문가',
    },
    {
      key: 'secretary_economic', label: '경제비서관', emoji: '📊',
      assignedSection: 'economic_feasibility',
      sectionLabel: '경제비서실 — 재정 타당성 및 예산 조정안',
      sectionPlaceholder: '경제비서관으로서 비빔민국 통계 데이터에 기반하여 각 부처가 청구한 예산의 단가 타당성을 검증하고, 예산 초과분 조정을 위한 시뮬레이션을 작성하세요.',
      memoGuide: [
        '① [예산 단가 검증] 각 부처 예산 중 비빔민국 통계(10만 명 기준)에 비추어 단가가 너무 높거나 비현실적으로 책정된 항목이 있는지 검토하세요.',
        '② [재정 효과 평가] 예산을 집중 투입했을 때 가장 큰 경제적 기대효과(일자리, 복지 등)를 낼 수 있는 사업은 무엇인가요?',
        '③ [예산 조정안 수립] 전체 청구액이 100억을 넘을 경우, 어떤 기준과 비율로 예산을 삭감 또는 증액하여 조정할 것인지 구체적인 안을 마련하세요.'
      ],
      todos: [
        { label: '비빔민국 통계 연계 예산 단가 적정성 분석', hint: '국가 통계 데이터와 각 부처 청구 단가를 비교하여 과다 청구된 부분을 가려내세요.' },
        { label: '부처별 예산 투입 대비 경제성 및 효율성 평가', hint: '어느 정책에 예산을 먼저 주어야 경제적 파급 효과가 클지 우선순위를 매기세요.' },
        { label: '대통령실 최종 예산 조정/배정 시뮬레이션 수립', hint: '대통령의 예산 결정을 보좌하기 위해 100억에 맞춘 세부 예산 배정 시트를 설계하세요.' }
      ],
      sosWhen: '\'예산 타당성 분석 및 수치 계산이 어려울 때\'',
      sosLabel: '재무 분석관',
    }
  ],
  judicial: [
